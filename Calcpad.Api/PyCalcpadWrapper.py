...
class MathSettings:
    ...
    def ZeroSmallMatrixElements(self, value):
...
class PlotSettings:
    ...
    def ScreenScaleFactor(self):
        return self._instance.ScreenScaleFactor

    @ScreenScaleFactor.setter
    def ScreenScaleFactor(self, value : float):
        self._instance.ScreenScaleFactor = value

    @property
    def ImagePath(self):
        return self._instance.ImagePath

    @ImagePath.setter
    def ImagePath(self, value : str):
        self._instance.ImagePath = value

    @property
    def ImageUri(self):
        return self._instance.ImageUri
...
class Calculator:
    def __init__(self, settings):
        self._instance = Activator.CreateInstance(CalculatorType, settings._instance)
