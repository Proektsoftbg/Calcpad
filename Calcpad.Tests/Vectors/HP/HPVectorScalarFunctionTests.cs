...
{
    public class HPVectorScalarFunctionTests
    {
        ...
        {
            string vector = "hp([-3.5; 7.8; 4.25; 0; 10; -2.3; 6.75])";
        ...
        public void HPVectorGetUnits()
        {
            var calc = new TestCalc(new());
            calc.Run([
                "v = hp([1dm; -2dm; -3dm; 4dm; 5dm; 6dm; 7dm; 8dm; 9dm])",
                "getunits(v)"
            ]);
