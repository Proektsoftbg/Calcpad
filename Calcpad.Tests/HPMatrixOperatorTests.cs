...
{
    public class HPMatrixOperatorTests
    {
        #region HPMatrix
        [Fact]
        ...
        [Fact]
        [Trait("Category", "HPScalarMatrix")]
        public void HPScalarMatrixLogicalAnd()
        {
            string matrix = "hp([1; 0; 1 | 0; 1 ; 0 | 1; 0; 1])";
            string x = "1";
            var calc = new TestCalc(new());
        ...
        [Fact]
        [Trait("Category", "HPScalarMatrix")]
        public void HPScalarMatrixLogicalOr()
        {
            string matrix = "hp([1; 0; 1 | 0; 1 ; 0 | 1; 0; 1])";
            string x = "0";
            var calc = new TestCalc(new());
        ...
        [Fact]
        [Trait("Category", "HPScalarMatrix")]
        public void HPScalarMatrixLogicalXor()
        {
            string matrix = "hp([1; 0; 1 | 0; 1 ; 0 | 1; 0; 1])";
            string x = "1";
            var calc = new TestCalc(new());
            calc.Run($"{x} ⊕ {matrix}");
            Assert.Equal("[0 1 0|1 0 1|0 1 0]", calc.ToString());
        }
        #endregion
