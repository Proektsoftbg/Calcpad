...
namespace Calcpad.Tests
{
    public class HPVectorComparison
    {
        ...
        private string[] OperatorTestHelper(char o) => new string[]{"n = 1000",
        ...
        private string[] FunctionTestHelper(string s) => new string[]{"n = 1000",
                            "a = random(fill(vector(n); 1))",
                            $"c = {s}(a)",
                            $"c_hp = {s}(hp(a))",
                            "r = c ≡ c_hp",
        ...
        private string[] ScalarTestHelper(string s) => new string[]{"n = 1000",
                            "a = random(fill(vector(n); 1))",
                            $"c = {s}(a)",
                            $"c_hp = {s}(hp(a))",
                            "r = c ≡ c_hp" };
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("sin"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("cos"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("tan"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("csc"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("sec"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("cot"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("sinh"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("cosh"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("tanh"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("csch"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("sech"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("coth"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("asin"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("acos"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("atan"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("acsc"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("asec"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("acot"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("asinh"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("acosh"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("atanh"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("acsch"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("asech"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("acoth"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("log"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("ln"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("log_2"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("exp"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("sqrt"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("cbrt"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("round"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("floor"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("trunc"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(ScalarTestHelper("product"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(ScalarTestHelper("mean"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(ScalarTestHelper("take"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(ScalarTestHelper("Line"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(ScalarTestHelper("spline"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("sort"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("rsort"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("order"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("revorder"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(FunctionTestHelper("reverse"));
        ...
        {
            var calc = new TestCalc(new());
            calc.Run(ScalarTestHelper("norm_i"));
