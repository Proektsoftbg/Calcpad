...
namespace Calcpad.Core
{
    ...
    {
#if BG
        internal static void InvalidSyntax(string s) => 
        ...
        internal static void InvalidUnits(string s) =>    
            ThrowNew($"Невалидни мерни единици: \"{s}\".");
        internal static void InvalidLiteral(string s, string literal) =>
            ThrowNew($"Не мога да изчисля \"{s}\" като {literal}.");
        internal static void InvalidNumber(string s) =>
        ...
        internal static void CannotEvaluateFunction(string s) =>
            ThrowNew($"Не мога да изчисля функцията %F за %V = {s}.");
        internal static void FunctionNotDefined(string s) =>
            ThrowNew($"Функцията %F не е дефинирана за %V = {s}.");
        internal static void InconsistentUnits(string u1, string u2) =>
            ThrowNew($"Несъвместими мерни единици: \"{u1}\" и \"{u2}\".");
        internal static void IterationLimits(string l1, string l2) =>
            ThrowNew($"Границите са извън допустимите: [{l1}; {l2}].");
        internal static void InvalidUnitsFunction(string func, string unit) =>
            ThrowNew($"Невалидни мерни единици за функция: \"{func}({unit})\".");
        internal static void RootUnitless(string u1, string u2) =>
	        ThrowNew("Коренният показател трябва да е бездименсионен.");
        internal static void RootComplex(string u1, string u2) =>
	        ThrowNew("Коренният показател не може да е комплексно число.");
        internal static void RootInteger(string u1, string u2) =>
	        ThrowNew("Коренният показател трябва да е цяло число > 1.");
        internal static void FactorialArgumentOutOfRange(string u1, string u2) =>
	        ThrowNew("Аргументът e извън допустимите стойности n!.");
        internal static void FactorialArgumentUnitless(string u1, string u2) =>
        ...
        internal static void ReminderUnits(string u1, string u2) =>
        ...
        internal static void VariableNotExist(string name) =>
            ThrowNew($"Недифинирана променлива '{name}'.");
        internal static void UnitNotExist(string name) =>
        ...
        internal static void InvalidFunction(string s) =>
            ThrowNew($"Невалидна функция: \"{s}\".");
        internal static void CannotEvaluateAsType(string literal, string type) =>
        ...
        internal static void UndefinedVariableOrUnits(string s) =>
            ThrowNew($"Недефинирана променлива или мерни единици: \"{s}\".");
        internal static void ErrorEvaluatingAsFunction(string s) =>
            ThrowNew($"Грешка при изчисляване на \"{s}\" като функция.");
        internal static void ErrorEvaluatingAsFunctionOrOperator(string s) =>
            ThrowNew($"Грешка при изчисляване на \"{s}\" като функция или оператор.");
        internal static void CannotRewiriteUnits(string s) =>
            ThrowNew($"Не мога да презапиша съществуващи единици: {s}.");
        internal static void InconsistentTargetUnits(string sourceUnits, string targetUnits) =>
        ...
        internal static void InvalidMacro(string s) =>
            ThrowNew($"Невалидeн идентификатор на макро \"{s}$\".");
        internal static void InvalidSolver(string s) =>
            ThrowNew($"Невалидна дефиниция на команда за числени методи \"{s}\".");
        internal static void ErrorParsingUnits(string s) =>
            ThrowNew($"Грешка при опит за разпознаване на \"{s}\" като мерни единици.");
        internal static void ErrorParsingNumber(string s) =>
            ThrowNew($"Грешка при опит за разпознаване на \"{s}\" като число.");
        internal static void MissingDelimiter(string delimiter, string script) =>
            ThrowNew($"Липсва разделител \"{delimiter}\" в команда за числени методи {{{script}}}.");
        internal static void MultipleAssignments(string s) =>
            ThrowNew($"Повече от един оператор '=' в '{s}'.");
        internal static void InconsistentUnits2(string variable, string u1, string u2) =>
            ThrowNew($"Несъвместими мерни единици за \"{variable} = {u1} : {u2}\".");
        internal static void ConstantExpression(string s) =>
            ThrowNew($"Изразът от дясната страна трябва да е константа: \"{s}\".");
        internal static void InconsistentUnits1(string variable, string units) =>
            ThrowNew($"Несъвместими мерни единици за \"{variable} = {units}\".");
        internal static void NoSolution(string s) =>
            ThrowNew($"Няма решение за: {s}.");
        internal static void RecursionNotAllowed(string s) =>
        ...
        internal static void InvalidSyntax(string s1, string s2) =>
        ...
        internal static void ResultNotReal(string s) =>
        ...
        internal static void InvalidFunctionToken(string name) =>
            ThrowNew($"Невалиден обект в дефиниция на функция: \"{name}\".");
        internal static void CircularReference(string name) =>
        ...
        internal static void ArgumentOutOfRange(string func) =>
        ...
        internal static void ErrorWritingPngFile(string path) =>
            ThrowNew($"Грешка при запис на png файл като \"{path}\".");
        internal static void ErrorWritingSvgFile(string path) =>
        ...
        internal static void InconsistentUnitsOp(string ua, string op, string ub) =>
        ...
        internal static void CannotEvaluateReminder(string ua, string ub) =>
            ThrowNew($"Не мога да изчисля остатъка: \"{ua}  %  {ub}\". Делителят трябва да е бездименсионен.");
        internal static void IvalidFunctionToken(string s) =>
        ...
        internal static void MissingDelimiter(char delimiter, string script) =>
        ...
        internal static void InconsistentUnitsOp(string ua, char op, string ub) =>
        ...
        private static void ThrowNew(string s) =>
        ...
        internal static T InvalidUnits<T>(string s)
        {
            InvalidUnits(s);
            return default;
        }
